...
export default [
  layout("routes/_app.tsx", [
    ...
    route("settings/securities",             "routes/_app.settings.securities.tsx"),
    route("settings/securities/new",         "routes/_app.settings.securities.new.tsx"),
    route("settings/securities/:id/edit",    "routes/_app.settings.securities.$id.edit.tsx"),
    ...
    route("reconcile",                         "routes/_app.reconcile._index.tsx"),
    route("reconcile/:id",                     "routes/_app.reconcile.$id.tsx"),
